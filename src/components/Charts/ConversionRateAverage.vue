...
const chartDiv = useTemplateRef('conversion-rate-average')
let root = null
...
<template>
  ...
  >
    <h4 class="font-semibold text-sm">Conversion Rate Average Per Day</h4>
    <div ref="conversion-rate-average" class="h-full w-full"></div>
  </div>
</template>
