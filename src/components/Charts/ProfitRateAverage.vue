...
const chartDiv = useTemplateRef('profit-rate-average')
let root = null
...
<template>
  ...
  >
    <h4 class="font-semibold text-sm">Profit Rate Average</h4>
    <div ref="profit-rate-average" class="h-full w-full"></div>
  </div>
</template>
